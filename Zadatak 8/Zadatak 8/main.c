...
int main(void)
{
	...
	while (1)
	{
		data=USART_receive();
		USART_send(data);
		//broj '10' ili '11' može se nalaziti izme?u 8. (ako je razina svjetlosti troznamenkasta) i 5. mjesta (ako je razina svjetlosti jednoznamenkasta) u stringu
		if(((data%10000000)*10 + (data%1000000))||((data%1000000)*10 + (data%100000))||((data%100000)*10 + (data%10000)) == '11' ){
